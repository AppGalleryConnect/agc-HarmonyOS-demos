...
public class Widget4Slice extends AbilitySlice {
    private static final String PARAMS = "params";
    private static final String MESSAGE = "message";

    @Override
    public void onStart(Intent intent) {
        Component component = LayoutScatter.getInstance(this).parse(ResourceTable.Layout_multiple_contact_widget4, null, false);
        Text text = (Text) component.findComponentById(ResourceTable.Id_page4);
